namespace OOP
{
    public interface ISorter<T> where T : class, IComparable
    {
    ...
    internal static class ComparatorDetails<T> where T : class, IComparable
    {
    ...
    public class BasicSorter<T> where T : class, IComparable
    {
        ...
        public void Sort(IList<T> array)
        {
            ...
            WriteLine($"Sorted array successfully. Duration: {end - start}");
        }
    }

    public class SorterLogConsole<T> : BasicSorter<T> where T : class, IComparable
    {
    ...
    public class SorterLogFile<T> : BasicSorter<T> where T : class, IComparable
    {
